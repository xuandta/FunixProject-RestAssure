...
public class TC_API_Login {
	...
	public void init() throws IOException {
		...
		String loginPath = ExcelReadAndWrite.getValuefromKey("./data/propertiesFile.xlsx","Sheet1","loginPath");
		
		account = ExcelReadAndWrite.getValuefromKey("./data/propertiesFile.xlsx","Sheet1","account");
		password = ExcelReadAndWrite.getValuefromKey("./data/propertiesFile.xlsx","Sheet1","password");
	...
	public void TC03_ValidateToken() throws IOException {
        ...
        ExcelReadAndWrite.SaveToken(token);
	}
